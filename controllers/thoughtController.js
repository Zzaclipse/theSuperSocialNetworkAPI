...
module.exports = {
  ...
  //       console.log(`reac array before push ${reactionArray}`);
  //       reactionArray.push(req.body);
  //       console.log(`reac array after push ${reactionArray}`);

  //       let updatedThought = await Thought.findOneAndUpdate(
  //         { _id: req.params.thoughtId },
  //         { reactions: reactionArray }
  //       );
  //       let savedThought = await updatedThought.save();
  //       res
  //         .status(200)
  //         .json({ message: `Reaction added to ${savedThought._id}` });
  //     })
  //     .catch((err) => res.status(500).json(err));
  // },
